      ...
      <Flex width="100%" flexDir="column" px={['8', '4.5rem']} pt="30" pb="6">
        <Flex>
          ...
          >
            ...
            />
            <path
              d="M54.9099 47.0566C52.1549 43.8266 49.8432 41.0716 47.0566 37.8416C45.5999 36.1316 43.7316 34.4216 41.5149 33.6616C41.1666 33.5349 40.8182 33.4399 40.4699 33.3766C39.6782 33.2499 38.8232 33.2499 37.9999 33.2499C37.1766 33.2499 36.3216 33.2499 35.4982 33.4083C35.1499 33.4716 34.8016 33.5666 34.4532 33.6933C32.2366 34.4533 30.3999 36.1633 28.9116 37.8733C26.1566 41.1033 23.8449 43.8583 21.0582 47.0883C16.9099 51.2366 11.8116 55.8283 12.7616 62.2566C13.6799 65.4866 15.9916 68.6849 20.1399 69.6033C22.4516 70.0783 29.8299 68.2099 37.6832 68.2099H38.2532C46.1066 68.2099 53.4849 70.0466 55.7966 69.6033C59.9449 68.6849 62.2566 65.4549 63.1749 62.2566C64.1566 55.7966 59.0582 51.2049 54.9099 47.0566Z"
              fill="#00ACC1"
            />
          </svg>
        </Flex>
